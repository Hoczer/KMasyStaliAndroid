...
{
    [Activity(Label = "ProfilActivity", ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation, ScreenOrientation = ScreenOrientation.Portrait)]
    public class ProfilActivity : Activity
    {
        ...
        private void LiczButton_Click(object sender, EventArgs e)
        {
            ...
            //decimal odjeteGrubosci = ((z * 4m) + (0.35M*4)) / 1000;
